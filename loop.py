...
from runner import run_candidate   # swapped from the temporary in-file placeholder — see
                                     # runner.py's history for the env-var fix that made this
                                     # safe to do (KUAIRAND_REPO_ROOT/KUAIRAND_DATA_DIR were
                                     # missing before pipeline.py could rely on them here)
